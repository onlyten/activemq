...
// include_once 'Message/Map.php';
// include_once 'Exception/StompException.php';
// include_once 'ExceptionInterface.php';
    ...
    */
    ...
    public function connect ($username = '', $password = '')
    {
        ...
        if ($frame instanceof Frame && $frame->command == 'CONNECTED') {
            ...
            if (isset($frame->headers['server']) && false !== stristr(trim($frame->headers['server']), 'activemq')) {
